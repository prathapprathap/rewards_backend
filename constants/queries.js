module.exports = {
    USER: {
        ...
        GET_USER_BY_REFERRAL_CODE: 'SELECT id, referral_code FROM users WHERE UPPER(referral_code) = UPPER(?)',
    ...
    ADMIN: {
        ...
        amount, currency_type, event_name, description, image_url, refer_payout, status, requires_screenshot
      ) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)`,
        GET_ALL_OFFERS: `
          SELECT o.*, 
